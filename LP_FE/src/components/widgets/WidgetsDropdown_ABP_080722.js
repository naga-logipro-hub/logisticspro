...
const Ownvehicle_shipment = () => {
  DashboardService.getDashboardOverAllDetails().then((res) => {
    ...
    const ownshipment = tableData.filter(
      (data) =>
        (
          (data.vehicle_type_id.id != 3 && data.vehicle_current_position == '18' && data.trip_sheet_info.purpose == '1' && data.trip_sheet_info.to_divison == '1')||(data.vehicle_type_id.id != 3 && data.vehicle_current_position == '18' && data.parking_status == '11' && data.trip_sheet_info.purpose == '1' && data.trip_sheet_info.to_divison == '2') || (data.vehicle_type_id.id != 3 && data.vehicle_current_position == '18' && data.parking_status == '1' && data.trip_sheet_info.purpose == '1' && data.trip_sheet_info.to_divison == '2')||(data.vehicle_type_id.id != 3 && data.vehicle_current_position == '20')||(data.vehicle_type_id.id != 3 && data.vehicle_current_position == '21'))
    )
        /*Shipment Over All Vehicle */
    const overallshipment = tableData.filter(
      (data) =>
        (
          (data.vehicle_current_position == '20')||(data.vehicle_current_position == '21')||(data.vehicle_current_position == '18' && data.trip_sheet_info.purpose == '1' && data.trip_sheet_info.to_divison == '1' && data.vehicle_type_id.id != 3)||(data.vehicle_current_position == '18' && data.parking_status == '11' && data.trip_sheet_info.purpose == '1' && data.trip_sheet_info.to_divison == '2' &&data.vehicle_type_id.id != 3) || (data.vehicle_current_position == '18' && data.parking_status == '1' && data.trip_sheet_info.purpose == '1' && data.trip_sheet_info.to_divison == '2' && data.vehicle_type_id.id != 3) || (data.vehicle_current_position == '16' && data.trip_sheet_info.purpose == '1' && data.vehicle_type_id.id == 3))
    )
    ...
    const Hireshipment = tableData.filter(
      ...
      const OwnAdvance = tableData.filter(
       ...
       const OverallDiesel = tableData.filter(
        (data) =>
          (
            (data.vehicle_type_id.id != 3 && data.vehicle_current_position == '22')||(data.vehicle_type_id.id != 3 && data.vehicle_current_position == '25') || (data.vehicle_type_id.id != 3 && data.vehicle_current_position == '18' && data.trip_sheet_info.purpose == '2') || (data.vehicle_type_id.id != 3 && data.vehicle_current_position == '16' && data.parking_status == '8' &&data.trip_sheet_info.purpose == '3') || (data.vehicle_type_id.id == 3 && data.vehicle_current_position == '18' && data.trip_sheet_info.purpose == '2' && data.advance_info.advance_payment_diesel !='0') || (data.vehicle_type_id.id == 3 && data.vehicle_current_position == '18' && data.trip_sheet_info.purpose == '1' && data.advance_info.advance_payment_diesel !='0') || (data.vehicle_current_position == '37') || (data.vehicle_current_position == '39'))
      )
      const OwnDiesel = tableData.filter(
        (data) =>
          (
            (data.vehicle_type_id.id != 3 && data.vehicle_current_position == '22')||(data.vehicle_type_id.id != 3 && data.vehicle_current_position == '25') || (data.vehicle_type_id.id != 3 && data.vehicle_current_position == '18' && data.trip_sheet_info.purpose == '2') || (data.vehicle_type_id.id != '3' && data.vehicle_current_position == '16' && data.parking_status == '8' && data.trip_sheet_info.purpose == '3')||(data.vehicle_type_id.id != '3' && data.vehicle_current_position == '39'&& data.trip_sheet_info.purpose == '3')||(data.vehicle_type_id.id != '3' && data.vehicle_current_position == '39'  && data.trip_sheet_info.purpose == '3')||(data.vehicle_type_id.id != '3' && data.vehicle_current_position == '37') || (data.vehicle_type_id.id != '3' &&data.vehicle_current_position == '39'))
      )
      const HireDiesel = tableData.filter(
        (data) =>
          (
             (data.vehicle_type_id.id == 3 && data.vehicle_current_position == '18' && data.trip_sheet_info.purpose == '2' && data.advance_info.advance_payment_diesel !='0') ||(data.vehicle_type_id.id == 3 && data.vehicle_current_position == '18' && data.trip_sheet_info.purpose == '1' && data.advance_info.advance_payment_diesel !='0')|| (data.vehicle_type_id.id == '3' && data.vehicle_current_position == '37'&& data.trip_sheet_info.purpose == '3')||(data.vehicle_type_id.id == '3' && data.vehicle_current_position == '39'  && data.trip_sheet_info.purpose == '3')||(data.vehicle_type_id.id == '3' && data.vehicle_current_position == '37') || (data.vehicle_type_id.id == '3' &&data.vehicle_current_position == '39'))
      )
