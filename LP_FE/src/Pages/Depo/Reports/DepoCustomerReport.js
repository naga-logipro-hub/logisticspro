...
const DepoCustomerReport = () => {
  ...
  let page_no = LogisticsProScreenNumberConstants.DepoModuleScreens.Depo_customer_report
  ...
  const loadDepoReport = (fresh_type = '') => {
    ...
    if (fresh_type != '1') {
      ...
      let report_form_data = new FormData()
       ...
       DepoCustomerMasterService.sentDataForReport(report_form_data).then((res)=>{
...
export default DepoCustomerReport
