...
const DeliveryOrderInfo = ({ all_delivery_data, delivery_id }) => {
  ...
  let filtered_data = all_delivery_data.filter((c, index) => {
    if (all_del_nos.includes(c.DeliveryOrderNumber)) {
      return true
    } else {
      all_del_nos.push(c.DeliveryOrderNumber)
    }
  })
  ...
  let lineItem = data.DeliveryItems
  ...
  Object.keys(lineItem).forEach(function (key) {
    ...
    delivery_orders_array['delivery_net_qty_mts'] = lineItem[key].DEL_NET_MTS
    ...
    del_line_items.push({
      ...
      LineItemNetQtyInMTS: delivery_orders_array['delivery_net_qty_mts'],
    })
  })
          ...
          <CRow>
            <CCol xs>
              <CInputGroup>
                ...
                <CFormInput readOnly value={data.SaleOrderNumber} />
              </CInputGroup>
            </CCol>
            ...
            <CCol xs>
              <CInputGroup>
                ...
                <CFormInput readOnly value={data.DeliveryOrderNumber} />
              </CInputGroup>
            </CCol>
          </CRow>
          ...
          <CRow>
            <CCol xs>
              <CInputGroup>
                ...
                <CFormInput readOnly value={formatDate(data.SaleOrderDate)} />
              </CInputGroup>
            </CCol>
            ...
            <CCol xs>
              <CInputGroup>
                ...
                <CFormInput readOnly value={formatDate(data.DeliveryOrderDate)} />
              </CInputGroup>
            </CCol>
          </CRow>
          ...
          <CRow className="mb-3">
            <CCol xs>
              <CInputGroup>
                ...
                <CFormInput readOnly value={data.SaleOrderQty} />
              </CInputGroup>
            </CCol>
            ...
            <CCol xs>
              <CInputGroup>
                ...
                {/* <CFormInput readOnly value={data.DeliveryQty} /> */}
                <CFormInput readOnly value={data.DeliveryNetQty} />
              </CInputGroup>
            </CCol>
          </CRow>
        </CContainer>
          ...
          <CRow>
            <CCol xs={12}>
              <CInputGroup>
                ...
                <CFormInput readOnly value={data.CustomerName} />
              </CInputGroup>
            </CCol>
          </CRow>
          <CRow>
            <CCol xs={12}>
              <CInputGroup>
                ...
                <CFormInput readOnly value={data.CustomerCode} />
              </CInputGroup>
            </CCol>
          </CRow>
          <CRow>
            <CCol xs={12}>
              <CInputGroup>
                ...
                <CFormInput readOnly value={data.CustomerCity} />
              </CInputGroup>
            </CCol>
          </CRow>
          <CRow>
            <CCol xs={12}>
              <CInputGroup>
                ...
                <CFormInput readOnly value={data.CustomerRoute} />
              </CInputGroup>
            </CCol>
          </CRow>
        </CContainer>
                    ...
                    return (
                      <>
                        <CTableRow style={{ background: '#ebc999' }}>
                          ...
                          <CTableDataCell>{val.LineItemNetQtyInMTS}</CTableDataCell>
                        </CTableRow>
                      </>
                    )
                  })}
