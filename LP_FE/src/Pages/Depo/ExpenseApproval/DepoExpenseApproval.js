...
const DepoExpenseApproval = () => {
 ...
 const locationFinder = (data) =>{
  ...
  useEffect(() => {
      ...
      DepoExpenseClosureService.getClosureInfoById(id).then((res) => {
        setFetch(true)
  ...
  const expenseApproval = (type) => {
    ...
    formData.append('status', type == 1 ? 28 : 26)
    formData.append('approval_status', type == 1 ? 2 : 3)
    formData.append('closure_id', id)
    formData.append('updated_by', user_id)
    formData.append('parking_id', expenseClosureData.parking_yard_info.depo_parking_yard_gate_id)

    DepoExpenseClosureService.updateExpenseApproval(formData).then((res) => {
      setFetch(true)
      ...
      if (res.status == 200) {
        ...
        Swal.fire({
          icon: "success",
          title: type == 1 ? 'Trip Additional Expenses Approved Successfully..!' : 'Trip Additional Expenses Rejected Successfully..!',
          confirmButtonText: "OK",
        }).then(function () {
          navigation('/DepoExpenseApprovalTable')
        });
                    ...
                    <CTabContent>
                      <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKey === 1}>
                        ...
                        {expenseClosureData && (
                          <CRow className="">
                              ...
                              <>
                                ...
                                <CCol md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="clo"
                                    value={locationFinder(expenseClosureData.contractor_info.contractor_location)}
                                    readOnly
                                  />
                                </CCol>
                                ...
                                <CCol md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="cfr"
                                    value={expenseClosureData.contractor_info.freight_type == '2' ? 'Actual Freight' :'Budget Freight'}
                                    readOnly
                                  />
                                </CCol>
                              </>
                              ...
                              <>
                                ...
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="vbt"
                                    value={`${expenseClosureData.vehicle_info.vehicle_capacity_info.capacity} - Ton / ${expenseClosureData.vehicle_info.vehicle_body_type_info.body_type}`}
                                    readOnly
                                  />
                                </CCol>
                                <CCol xs={12} md={3}>
                            ...
                            {expenseClosureData.vehicle_inspection_info && (
                              <CCol xs={12} md={3}>
                                ...
                                <CFormInput
                                  ...
                                  value={expenseClosureData.vehicle_inspection_info.inspection_time_string}
                                  readOnly
                                />
                              </CCol>
                            )}
                              ...
                              <>
                                <CCol md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="TNum"
                                    value={expenseClosureData.trip_sheet_info.depo_tripsheet_no}
                                    readOnly
                                  />
                                </CCol>
                                <CCol md={3}>
                            ...
                            {expenseClosureData.shipment_parent_info && (
                              <>
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="SRDateTime"
                                    value={expenseClosureData.shipment_parent_info.shipment_no}
                                    readOnly
                                  />
                                </CCol>
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="SRDateTime"
                                    value={expenseClosureData.shipment_parent_info.shipment_date_time_string}
                                    readOnly
                                  />
                                </CCol>
                              </>
                      ...
                      <CTabPane role="tabpanel" aria-labelledby="profile-tab" visible={activeKey === 2}>
                         <>
                            ...
                            <CRow key={`HireshipmentData1`} className="mt-2" hidden>
                              ...
                              <CCol md={2}>
                                ...
                                <CFormInput
                                  ...
                                  size="sm"
                                  id="ShQty"
                                  // value={shipmentInfo.final_shipment_qty}
                            ...
                            {shipmentInfo.shipment_child_info && shipmentInfo.shipment_child_info.map((val, val_index) => {
                              return (
                                <>
                                    ...
                                    <CRow key={`HireshipmentChildData_${val_index}`}>
                                      ...
                                      <CCol xs={12} md={2}>
                                        ...
                                        {imageUrlValidation(shipmentInfo.shipment_child_info[val_index].fj_pod_copy) ? (

                                          <CButton className="w-100 m-0" color="info" size="sm" id="inputAddress">
                                            <span className="float-start">
                                              &nbsp;{imageUrlValidation(shipmentInfo.shipment_child_info[val_index].fj_pod_copy,'url')}
                                            </span>
                                            <span className="float-end">
                                              <i
                                                ...
                                                onClick={() => {
                                                  setCamEnable(true)
                                                  setImgSrc(shipmentInfo.shipment_child_info[val_index].fj_pod_copy)
                                          ...
                                          <>
                                            <CButton className="w-100 m-0" color="danger" size="sm" id="inputAddress">
                                              <span className="float-start">
                                                Image Not Found
                                              </span>
                                            </CButton>
...
export default DepoExpenseApproval
