...
const ShipmentInfoConsumer = () => {
  ...
  const insertDelivery = (data_for_inserted_deliveries) => {
    ...
    var depo_party_location_array = [2,3,4,5]

    /* Foods Party Locations 1-Dindigul, 6-Aruppukotai */
    var foods_party_location_array = [1,6]
    ...
    if (shipmentData.vehicle_type_id == '1') {
      ...
      if(inArray(shipmentData.vehicle_location_id,depo_party_location_array)){
    ...
    VehicleAssignmentSapService.updateShipmentByDeliveryInsert(ShipmentCreationSendData_seq).then(
      (res) => {
        ...
        if (
          ...
          //   'shipment_qty',
          //   (shipmentData.shipment_qty - deliveryQty).toFixed(2)
          // )
          ...
          <CCard>
            <CTabContent>
              ...
              <CRow className=""> */}
                  ...
                  <CRow className="mt-3">
                    <CCol>
                      <Link to="/ShipmentCreationConsumer">
...
export default ShipmentInfoConsumer
