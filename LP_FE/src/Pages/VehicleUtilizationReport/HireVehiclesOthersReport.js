...
const HireVehiclesOthersReport = () => {
  ...
  /*================== User Id & Location Fetch ======================*/
    ...
    let page_no = LogisticsProScreenNumberConstants.VehicleUtilizationModule.HireOthers_Report
  ...
  const exportToCSV = () => {
    ...
    let fileName='OTHERS_Hire_Vehicles_Utilization_Report_'+dateTimeString
  ...
  const loadTripShipmentReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      VehicleUtilizationService.getHireOthersVehilceUtilizationDataForReport().then((res) => {
        // tableReportData = res.data.data
        tableReportData = res.data ? JSON.parse(res.data) : []  
        console.log(tableReportData,'getHireOthersVehilceUtilizationDataForReport')
      ...
      VehicleUtilizationService.sentHireOthersVehilceUtilizationDataForReport(report_form_data).then((res) => {
        
        tableReportData = res.data ? JSON.parse(res.data) : []  
        console.log(tableReportData,'sentHireOthersVehilceUtilizationDataForReport')
...
export default HireVehiclesOthersReport
