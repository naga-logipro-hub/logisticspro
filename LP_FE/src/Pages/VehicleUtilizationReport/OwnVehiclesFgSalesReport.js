...
const OwnVehiclesFgSalesReport = () => {
  ...
  /*================== User Id & Location Fetch ======================*/
    ...
    let page_no = LogisticsProScreenNumberConstants.VehicleUtilizationModule.OwnFGSales_Report
  ...
  const exportToCSV = () => {
    ...
    let fileName='FGSALES_Own_Vehicles_Utilization_Report_'+dateTimeString
  ...
  const loadTripShipmentReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      VehicleUtilizationService.getOwnFgsalesVehilceUtilizationDataForReport().then((res) => {
        // tableReportData = res.data.data
        tableReportData = res.data ? JSON.parse(res.data) : []  
        console.log(tableReportData,'getOwnFgsalesVehilceUtilizationDataForReport')
      ...
      VehicleUtilizationService.sentOwnFgsalesVehilceUtilizationDataForReport(report_form_data).then((res) => {
        console.log(res, 'res')
        tableReportData = res.data ? JSON.parse(res.data) : []  
        console.log(tableReportData,'getOwnFgsalesVehilceUtilizationDataForReport')
...
export default OwnVehiclesFgSalesReport
