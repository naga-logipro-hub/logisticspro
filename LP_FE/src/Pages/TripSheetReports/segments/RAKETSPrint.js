          ...
          >
            <tr>
              ...
              <td width="700" align="center" style={{ paddingTop:'1px',paddingBottom:'0px' }}>
                ...
                <strong style={hd1}>RAKE TRIPSHEET DETAILS</strong><br />
              </td>
            </tr>
            <tr>
              <td width="175" align="left"><strong>Tripsheet No</strong></td>
              <td width="175" align="left"> {singleVehicleInfo.rake_tripsheet_no}</td>        
              <td width="175" align="left"><strong>Tripsheet Date</strong></td>
              <td width="175" align="left"> {singleVehicleInfo.created_date}</td>
            </tr>
            <tr>
              <td width="175" align="left"><strong>FNR No</strong></td>
              <td width="175" align="left"> {singleVehicleInfo.fnr_no}</td>        
              <td width="175" align="left"><strong>Plant Name</strong></td>
              { singleVehicleInfo.tripsheet_creation_plant_info && (
                <td width="175" align="left"> 
                  {`${singleVehicleInfo.tripsheet_creation_plant_info.definition_list_name} (${singleVehicleInfo.tripsheet_creation_plant_info.definition_list_code})`}
                </td>
              )}
            </tr>
            <tr>
              ...
              <td width="175" align="left"> {singleVehicleInfo.driver_phone_number}</td>
            </tr>
            <tr>
