...
const TSClosureReport = () => {
  ...
  let page_no = LogisticsProScreenNumberConstants.TripSettlementScreens.Tripsheet_Expense_Closure_Report
  ...
  const exportToCSV = () => { 
    ...
    let fileName='LP_Trip_Closure_Report_'+dateTimeString 
  ...
  const loadTripClosureReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      report_form_data.append('closure_status', 0)

      TripSheetClosureService.sentClosureDataForReport(report_form_data).then((res) => {
        ...
        rowDataList = ClosureCommonForm(filterData,'1')
      ...
      report_form_data.append('closure_status', reportClosureStatus)
      console.log(defaultDate, 'defaultDate')
      console.log(reportVehicle, 'reportVehicle')

      console.log(reportTSNo, 'reportTSNo')
      console.log(reportClosureStatus, 'reportClosureStatus')
                ...
                <CRow className="mt-1 mb-1">
                  ...
                  <CCol xs={12} md={3}>
                    ...
                    <SearchSelectComponent
                      ...
                      search_type="closure_report_vehicle_number"
                  ...
                  <CCol xs={12} md={3}>
                    ...
                    <SearchSelectComponent
                      ...
                      search_type="closure_report_tripsheet_number"
                      search_data={searchFilterData}
                    />
                  </CCol>
                  ...
                  <CCol xs={12} md={3}>
                    ...
                    <SearchSelectComponent
                      ...
                      label="Select Closure Status"
                      noOptionsMessage="Status Not found"
                      search_type="closure_report_status"
                      search_data={searchFilterData}
                    />
                  </CCol>
                </CRow>
...
export default TSClosureReport
