...
const CustomerCreationConfirmationHome = () => {
...
/* ==================== Access Part End ========================*/
  ...
  useEffect(() => {
    CustomerCreationService.getCustomerCreationData().then((res) => {
      ...
      let rowDataList = []
      const filterData = tableData.filter((data) => data.customer_status == 2)
      ...
      filterData.map((data, index) => {
        ...
        rowDataList.push({
          ...
          Waiting_At: <span className="badge rounded-pill bg-info">Customer Approved</span>,
          Action: (
            <CButton className="badge text-white" color="warning">
              <Link
                className="text-white"
                to={`RJcustomerCreationConfrimation/${data.customer_id}`}>
                RJ Customer Confirmation
              </Link>
            </CButton>
          ),
        })
         ...
         <>
          <CCard>
            ...
            {/* <CRow className="mt-1 mb-1">
                ...
                >
                    <Link className="text-white" to="/RJcustomerCreationConfrimationHome/RJcustomerCreationConfrimationUpload">
...
export default CustomerCreationConfirmationHome
