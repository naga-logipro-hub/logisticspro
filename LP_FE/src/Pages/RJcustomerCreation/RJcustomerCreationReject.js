...
const RJcustomerCreationReject = () => {
      ...
      CustomerCreationService.updateCustomer(id,formData)
        .then((res) => {
          ...
          if (res.status === 200) {
            ...
            toast.warning('Failed To Assign Customer Creation.Kindly Contact Admin.!')
            navigation('/RJcustomerCreationHome')
            setFetch(false)
          }
        })
                    ...
                    />
                      ...
                      <CCol md={3}>
                        ...
                        <CButton className="w-100 m-0" color="info" size="sm" id="inputAddress">
                            {!fileuploaded || values.panCardattachment.name == '' ? (
                                <>
...
export default RJcustomerCreationReject
