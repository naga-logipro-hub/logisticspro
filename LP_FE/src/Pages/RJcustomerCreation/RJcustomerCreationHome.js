...
/* ==================== Access Part End ========================*/
  ...
  useEffect(() => {
    CustomerCreationService.getCustomerCreationData().then((response) => {
      ...
      let rowDataList = []
      const filterData = tableData.filter((data) => data.customer_status == 4)
      ...
      filterData.map((data, index)=> {
        ...
        rowDataList.push({
          ...
          Waiting_At: <span className="badge rounded-pill bg-info">Reject</span>,
          Action: (
            <CButton className="badge text-white" color="warning">
              <Link
                className="text-white"
                to={`RJcustomerCreationReject/${data.customer_id}`}>
          ...
          <CCard>
            <CContainer className="mt-1">
              <CRow className="mt-1 mb-1">
                ...
                >
                    {/* <Link className="text-white" to="/RJcustomerCreationHome/RJCustomerDetails">
