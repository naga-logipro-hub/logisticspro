...
const RakeMigoReport = () => {
  ...
  const exportToCSV = () => {
    ...
    let fileName='Rake_Migo_Report_'+dateTimeString
  ...
  const [reportTripsheetNo, setReportTripsheetNo] = useState(0)
  ...
  const loadTripSheetReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      RakeTripsheetCreationService.getMigoDataForReport().then((res) => {
      // RakeTripsheetCreationService.getTripsheetDataForReport().then((res) => {
        ...
        tableReportData.map((data, index) => {
          rowDataList.push({
            ...
            Driver_Name: data.trip_info.driver_name,
      ...
      RakeTripsheetCreationService.sentMigoDataForReport(report_form_data).then((res) => {
        console.log(res, 'res')
        tableReportData = res.data.data
                ...
                <CRow className="mt-1 mb-1">
                  ...
                  <CCol xs={12} md={3}>
                    ...
                    <SearchSelectComponent
                      ...
                      search_type="rake_tripsheet_migo_report_vehicle_number"
                  ...
                  <CCol xs={12} md={3}>
                    ...
                    <SearchSelectComponent
                      ...
                      search_type="rake_tripsheet_migo_report_tripsheet_number"
                      search_data={searchFilterData}
                    />
                  </CCol>
                  <CCol xs={12} md={3}>
                    <CFormLabel htmlFor="VNum">Trip Status</CFormLabel>
                    <SearchSelectComponent
                      size="sm"
                      className="mb-2"
                      onChange={(e) => {
