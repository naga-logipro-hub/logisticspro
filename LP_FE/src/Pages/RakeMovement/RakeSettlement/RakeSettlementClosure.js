...
const RakeSettlementClosure = () => {
  ...
  const settlementClosureSubmit = () => {
    ...
    // sap_data.append('REMARKS', values.settle_remarks) // Manager Remarks
                      ...
                      <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKey === 1}>
                        ...
                        {singleClosureSeqArray && singleClosureSeqArray.vendor_info && (
                          <CRow className="m-2">
                            ...
                            <CCol md={3}>
                              <CFormLabel htmlFor="cmn">Approval Date & Time</CFormLabel>
                              <CFormInput
                                style={{fontWeight: 'bolder'}}
                                name="cmn"
                                size="sm"
                        ...
                        <CRow className="mt-2">
                          <CCol className="m-2" xs={12} sm={12} md={3}>
                            <CButton size="sm" color="primary" className="text-white" type="button">
                              <Link className="text-white" to="/RakeSettlementClosureHome">
                                Previous
                              </Link>
                            </CButton>
                          </CCol>
                    ...
                    <CTabContent>
                      <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKey === 4}>
                        ...
                        <CRow className="mt-2">
                          ...
                          <CCol md={3}>
                            <CFormLabel htmlFor="cmn">Expense Posting Date / Invoice Copy</CFormLabel>
                          ...
                          >
                            ...
                            <CButton
                              ...
                              onClick={() => {
                                ...
                                settlementClosureSubmitValidation()
                              }}
                              type="submit"
                            >
                              Submit
...
export default RakeSettlementClosure
