...
const RakeVendorMaster = () => {
  ...
  const getPanData = (e) => {
    ...
    if (panNumbernew == '' || !panNumbernew) {
      toast.warning('Pan Card Number Required!')
      return false
    } else if (!/^[A-Z]{5}[\d]{4}[A-Z]{1}$/.test(panNumbernew)) {
      toast.warning(`Invalid Format. Must Like "ABCDE1234F"`)
      return false
    }
  ...
  function addNewVendor() {
    ...
    if(user_info.is_admin == 1){
      ...
      console.log('v_nam2', panData.NAME2)
    ...
    formData.append('v_name2', panData.NAME2)
    ...
    RakeVendorMasterService.createRakeVendor(formData).then((res) => {
                  ...
                  <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={true}>
                    <CForm className="row g-3 m-2 p-1" onSubmit={handleSubmit}>
                      <CRow className="mb-md-1">
                        ...
                        <CCol xs={12} md={3}>
                          <CFormLabel htmlFor="ownerName2">Vendor Name 2</CFormLabel>
                          <CFormInput name="ownerName2" size="sm" id="ownerName2" value={vendor ? (panData.NAME2 ? panData.NAME2 : '--') : '--'} readOnly />
                        </CCol>
                        <CCol xs={12} md={3}>
                        ...
                        <CCol xs={12} md={3}>
                          ...
                          <CFormInput
                            ...
                            id="city"
                            maxLength={20}
                            value={vendor ? (panData.CITY ? panData.CITY : '--') : '--'}
                            readOnly
                          />
                        </CCol>
                        <CCol md={3}>
...
export default RakeVendorMaster
