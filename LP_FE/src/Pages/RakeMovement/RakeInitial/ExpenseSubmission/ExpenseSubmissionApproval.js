...
const ExpenseSubmissionApproval = () => {
  ...
  let page_no = LogisticsProScreenNumberConstants.RakeModule.Rake_Expense_Approval
  ...
  const rejectAllExpenseSubmission = () => {
    ...
    // DepoExpenseClosureService.rejectPaymentValidation(formDataUpdate).then((res) => {
      ...
      if (res.status == 200) {
        Swal.fire({
          title: "Expense Submission Rejected Successfully!",
          icon: "success",
          confirmButtonText: "OK",
        }).then(function () {
          navigation('/RakeExpenseSubmissionApprovalHome')
        });
  ...
  const validationApproval = () => {
    ...
    // return false
    RakeClosureSubmissionService.approveExpenseSubmission(formDataUpdate).then((res) => {

      console.log(res)
      setFetch(true)
      if (res.status == 200) {
        Swal.fire({
          title: "Expense Submission Approved Successfully!",
          icon: "success",
          confirmButtonText: "OK",
        }).then(function () {
          navigation('/RakeExpenseSubmissionApprovalHome')
            ...
            <>
              <CCard className="p-1">
                ...
                >
                  ...
                  <CModalBody>
                    <p className="lead">Are you sure to reject this Expense Submission</p>
                    </CModalBody>
                  <CModalFooter>
                    <CButton
                      className="m-2"
                ...
                >
                  ...
                  <CModalBody>
                    <p className="lead">Are you sure to Approve this Expense Submission ?</p>
...
export default ExpenseSubmissionApproval
