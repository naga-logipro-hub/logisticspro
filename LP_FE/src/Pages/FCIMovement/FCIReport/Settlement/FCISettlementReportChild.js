...
const FCISettlementReportChild = () => {
  ...
  const exportToCSV = () => { 
    ...
    let fileName='FCI_MIGO_Expense_In_Income_Closure_Report_'+dateTimeString
                        ...
                        <CRow className="mt-2">
                          <CCol className="m-2" xs={12} sm={12} md={3}>
                            <CButton size="sm" color="primary" className="text-white" type="button">
                              <Link className="text-white" to="/FCISettlementReport">
                                Previous
                              </Link>
                            </CButton>
                          </CCol>
                            ...
                            <CRow className="m-2">                              
                              ...
                              <CCol xs={12} md={3}>
                                ...
                                <CFormInput
                                  ...
                                  size="sm"
                                  id="cmn"
                                  value={singleClosureSeqArray.income_posting_at_date} 
                                  readOnly
                                />                                 
                              </CCol>
                              <CCol xs={12} md={3}>
                                <CFormLabel htmlFor="incomePostingDate">
                                  SAP Income Document No. 
                                </CFormLabel>
                                <CFormInput
                                  style={{fontWeight: 'bolder'}}
                                  name="cmn"
                              ...
                              <CCol md={3}>
                                ...
                                <CFormInput
                                  ...
                                  size="sm"
                                  id="cmn"
                                  value={`${singleClosureSeqArray.income_customer_code == '20068' ? 'MMD (20068)' : 'FOODS (1012)'}`} 
                                  readOnly
                                />       
                                 
                              </CCol>
                              {singleClosureSeqArray.income_customer_code == 20068 ? (
                                <>
                                  <CCol xs={12} md={3}>
                                    <CFormLabel htmlFor="tdsremarks">SAP Income TDS Document No.</CFormLabel>
                                    <CFormInput
                                      style={{fontWeight: 'bolder'}}
                                      name="cmn"
                                      size="sm"
                                  ...
                                  <CCol xs={12} md={3}>
                                    <CFormLabel htmlFor="tdsremarks">TDS Receivable Remarks</CFormLabel>
                                    <CFormInput
                                      style={{fontWeight: 'bolder'}}
                                      name="cmn"
                                      size="sm"
                              ...
                              <CCol xs={12} md={3}>
                                <CFormLabel htmlFor="inclremarks">Income Closure Remarks</CFormLabel>
                                <CFormInput
                                  style={{fontWeight: 'bolder'}}
                                  name="cmn"
                                  size="sm"
...
export default FCISettlementReportChild
