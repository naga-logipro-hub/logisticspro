...
const FCIExpenseReportChild = () => {
  ...
  let page_no = LogisticsProScreenNumberConstants.FCIReportModule.FCI_Vendor_Assignment_Report
  ...
  const TRIP_CLOSURE_STATUS = [
    '',
    'Expense Submission Completed ✔️',
    'Expense Submission Approved ✔️',
    'Expense Submission Rejected ❌',
    'Expense Validation Verified ✔️',
    'Expense Validation Rejected ❌',
    'Expense Posted ✔️',
    'Expense Posting Rejected ❌',
    'Income Posted ✔️',     
    'Cancelled ❌'
  ]
  ...
  const IncomeAdditionalAmountFinder = () => {
    ...
    console.log(tonnage_freight,'IncomeAdditionalAmountFinder-sap_expense_amount')
  ...
  const incomePostingSubmit = () => {
    ...
    FCITripsheetSapService.fciSAPIncomePosting(sap_data).then((res) => {
        ...
        if (
          ...
          formDataUpdate.append('customer_code', fciDivision)
                ...
                <CTabContent className="p-3">
                  <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={mainKey === 1}>
                    ...
                    <CNav variant="tabs" role="tablist">
                      ...
                      {JavascriptInArrayComponent(singleClosureSeqArray.status,rejection_array) ? (
                        <>
                        </>
                      ) : (
                        <>
                          ...
                          {singleClosureSeqArray.status > 3 && (
                            <>
                              <CNavItem>
                                <CNavLink
                                  active={activeKey === 3}
                              ...
                              {singleClosureSeqArray.status == 6 && (                                                 
                                <CNavItem>
                                  <CNavLink
                                    active={activeKey === 4}
                      ...
                      <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKey === 1}>
                        ...
                        {singleClosureSeqArray && (
                          <CRow className="m-2">
                            ...
                            {singleClosureSeqArray.status > 1 && (
                              <>
                                <CCol md={3}>
                            ...
                            <CCol md={3}>
                              <CFormLabel htmlFor="cmn">Status</CFormLabel>
                              <CFormInput
                                style={{fontWeight: 'bolder'}}
                                name="cmn"
                                size="sm"
                                id="cmn"
                                value={TRIP_CLOSURE_STATUS[singleClosureSeqArray.status]}
                                readOnly
                              />
                            </CCol>
                            {JavascriptInArrayComponent(singleClosureSeqArray.status,rejection_array) && (
                              <CCol md={6}>
                                <CFormLabel htmlFor="cmn">Rejection Entries Note</CFormLabel>
                                <CFormInput
                                  style={{fontWeight: 'bolder'}}
                                  name="cmn"
                                  size="sm"
                                  id="cmn"
                                  value={'Rejection Entries should not have Migo,Expense,Income Informations.'}
                                  readOnly
                                />
                              </CCol>
                              // <span color='danger'>Test</span>
                            )
                        ...
                        <CRow className="mt-2">
                          <CCol className="m-2" xs={12} sm={12} md={3}>
                            <CButton size="sm" color="primary" className="text-white" type="button">
                              <Link className="text-white" to="/FCIExpenseReport">
                                Previous
                              </Link>
                            </CButton>
                          </CCol>
...
export default FCIExpenseReportChild
