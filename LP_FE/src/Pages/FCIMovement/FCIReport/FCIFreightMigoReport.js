...
const FCIFreightMigoReport = () => {
  ...
  const exportToCSV = () => {
    ...
    let fileName='FCI_Tripsheet_Freight_Migo_Report_'+dateTimeString
  ...
  const loadTripSheetReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      FCITripsheetCreationService.getTripsheetFreightMigoDataForReport().then((res) => { 
        tableReportData = res.data.data
        console.log(tableReportData,'getTripsheetFreightMigoDataForReport')
        ...
        tableReportData.map((data, index) => {
          rowDataList.push({
            ...
            Vendor_type:data.vendor_type == 1 ? 'Freight Vendor': 'Freight & Loading Vendor',
            ...
            SAP_Actual_Freight:data.sap_actual_freight,
            NLLD_Updated_Freight:data.nlld_updated_freight,
      ...
      FCITripsheetCreationService.sentTripsheetFreightMigoDataForReport(report_form_data).then((res) => {
        console.log(res, 'res')
        tableReportData = res.data.data 
        console.log(tableReportData,'sentTripsheetFreightMigoDataForReport')
  ...
  let page_no = LogisticsProScreenNumberConstants.FCIReportModule.FCI_Freight_Migo_report
...
export default FCIFreightMigoReport
