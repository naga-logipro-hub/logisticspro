...
const FreightExpenseSubmissionHome = () => {
  /*================== User Location Fetch ======================*/
        ...
        rowDataList.push({
          ...
          Action: (
            <CButton className="badge" color="warning">
              <Link className="text-white" to={`/FreightExpenseSubmission/${data.po_no}||${data.fci_plant_code}`}> 
                Expense Submission
              </Link>
            </CButton>
          ),
...
export default FreightExpenseSubmissionHome
