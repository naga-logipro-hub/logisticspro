...
const FCIVendorCreationRequest = () => {
        ...
        let kk = 0
          limn = limn +
            ...
            <tr style="border: 1px solid black" key=${kk+5}>
                ...
                <th style="width:40%">TDS TAX TYPE4</th>
    ...
    const VendorValidation = (statusCode) => {
        ...
        if(statusCode == 4 && values.remarks.trim() == ''){
  ...
  export default FCIVendorCreationRequest
