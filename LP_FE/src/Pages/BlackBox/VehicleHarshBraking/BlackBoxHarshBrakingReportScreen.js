...
const BlackBoxHarshBrakingReportScreen = () => {
  ...
  const exportToCSV = () => {
    ...
    let fileName='BB_Vehicle_Harsh_Braking_Report_'+dateTimeString
  ...
  const loadVehicleOverSpeedReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      BlackBoxService.getVehilceHarshBrakingInfo().then((res) => {
  
        tableReportData = res.data.data  
        console.log(tableReportData,'getVehilceHarshBrakingInfo')
        setFetch(true)
        let rowDataList = []
            ...
            Action: (
              <>
                <CButton className="btn btn-success btn-sm me-md-1">
                  <Link className="text-white" target='_blank' to={`/BlackBoxHarshBrakingReport/${data.id}`}>
      ...
      BlackBoxService.sentVehilceHarshBrakingInfo(report_form_data).then((res) => { 

        tableReportData = res.data.data  
        console.log(tableReportData,'sentVehilceHarshBrakingInfo')
...
export default BlackBoxHarshBrakingReportScreen
