...
const BlackBoxHarshAccelarationReportChild = () => {
  ...
  const assignVehicleInfo = (vdata,vno) => {
    ...
    let needed_data = filterData[0].HarshAcceleratorSubLst  
  ...
  useEffect(() => {
    BlackBoxService.getVHAInfoById(id).then((res) => {
      setFetch(true)
      let rowDataList = []
      ...
      vehicle_info_data.map((data, index) => { 
        rowDataList.push({
          ...
          over_speed_count: data.harsh_acceleration_count, 
          Action: (
            <>
                <CButton 
                    ...
                    onClick={() => {
                        ...
                        setDisplayVehicleOSCount(data.harsh_acceleration_count)
                      ...
                      <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={activeKey === 1}>
                        ...
                        <CRow className="mb-md-1">
                          <CCol
                            ...
                            md={12} 
                          > 
                            <Link to={'/BlackBoxHarshAccelarationReportScreen'}>
                              <CButton
                                size="s-lg"
                                color="primary"
...
export default BlackBoxHarshAccelarationReportChild
