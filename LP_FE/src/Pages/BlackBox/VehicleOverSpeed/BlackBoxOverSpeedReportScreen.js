...
const BlackBoxOverSpeedReportScreen = () => {
  ...
  const exportToCSV = () => {
    ...
    let fileName='BB_Vehicle_Over_Speed_Report_'+dateTimeString
  ...
  const loadVehicleOverSpeedReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      BlackBoxService.getVehilceOverSpeedInfo().then((res) => {
  
        tableReportData = res.data.data  
        console.log(tableReportData,'getVehilceOverSpeedInfo')
        setFetch(true)
        let rowDataList = []
      ...
      BlackBoxService.sentVehilceOverSpeedInfo(report_form_data).then((res) => { 

        tableReportData = res.data.data  
        console.log(tableReportData,'sentVehilceOverSpeedInfo')
...
export default BlackBoxOverSpeedReportScreen
