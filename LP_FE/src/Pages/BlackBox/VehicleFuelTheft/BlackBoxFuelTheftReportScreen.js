...
const BlackBoxFuelTheftReportScreen = () => {
  ...
  const loadVehicleOverSpeedReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      BlackBoxService.getVehilceFuelTheftInfo().then((res) => {
  
        tableReportData = res.data.data  
        console.log(tableReportData,'getVehilceFuelTheftInfo')
        setFetch(true)
        let rowDataList = []
              ...
              <> 
                {data.display_record_count != 0 ? (
                  <CButton className="btn btn-success btn-sm me-md-1">
                    <Link className="text-white" target='_blank' to={`/BlackBoxFuelTheftReport/${data.id}`}>
      ...
      BlackBoxService.sentVehilceFuelTheftInfo(report_form_data).then((res) => { 

        tableReportData = res.data.data  
        console.log(tableReportData,'sentVehilceFuelTheftInfo')
...
export default BlackBoxFuelTheftReportScreen
