...
const BlackBoxRashTurnReportScreen = () => {
  ...
  const loadVehicleOverSpeedReport = (fresh_type = '') => {
    ...
    if (fresh_type !== '1') {
      ...
      BlackBoxService.getVehilceRashTurnInfo().then((res) => {
  
        tableReportData = res.data.data  
        console.log(tableReportData,'getVehilceRashTurnInfo')
        setFetch(true)
        let rowDataList = []
            ...
            Action: (
              <>
                <CButton className="btn btn-success btn-sm me-md-1">
                  <Link className="text-white" target='_blank' to={`/BlackBoxRashTurnReport/${data.id}`}>
      ...
      BlackBoxService.sentVehilceRashTurnInfo(report_form_data).then((res) => { 

        tableReportData = res.data.data  
        console.log(tableReportData,'sentVehilceRashTurnInfo')
...
export default BlackBoxRashTurnReportScreen
