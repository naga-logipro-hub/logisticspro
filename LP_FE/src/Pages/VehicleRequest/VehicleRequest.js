...
import DivisionMasterComponent from 'src/components/MasterDropDownComponent/DivisionMasterComponent'
...
const VehicleRequest = () => {
  ...
  function addNewVR() {
    ...
    formData.append('vr_division', currentDivision)
    formData.append('vr_dept', currentDepartment)
    ...
    VehicleRequestMasterService.createVehicleRequest(formData).then((res) => {
      ...
      if (res.status == 200) {
        Swal.fire({
          title: 'Vehicle Request Created Successfully!',
          icon: "success",
        ...
        toast.warning('Vehicle Request Creation Failed. Kindly contact Admin..!')
      }
                    ...
                    <CForm className="row g-3 m-2 p-1" onSubmit={handleSubmit}>
                      <CRow className="mb-md-1">
                        {is_vr_admin == 1 ? (
                          <>
                            <CCol xs={12} md={3}>
                              <CFormLabel htmlFor="division">Division <REQ />{' '}
                              {currentDivision == 0 && (
                              ...
                              <DivisionMasterComponent
                                ...
                                className="mb-2"
                                onChange={(e) => {
                                  onChangeFilter(e,'division')
                                }}
                                label="Select Division"
                                noOptionsMessage="Division Not found"
                                search_type="division"
                                search_data={divisionData}
                              />
                            </CCol>
                            <CCol xs={12} md={3}>
                              <CFormLabel htmlFor="department">Department <REQ />{' '}
                              {currentDepartment == 0 && (
                                <span className="small text-danger">{'Required'}</span>
                              )}
                              </CFormLabel>
