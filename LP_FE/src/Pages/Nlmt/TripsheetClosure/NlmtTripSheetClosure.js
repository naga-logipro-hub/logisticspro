...
const NlmtTripSheetClosure = () => {
  ...
  values.halt_days = res.data.data[0].halt_days ? res.data.data[0].halt_days : ''
  values.tdsType = res.data.data[0].tds_type ? res.data.data[0].tds_type : ''
...
if (Number(tripInfo?.vehicle_info?.vehicle_type_id) === 22) {
  ...
  const handleStockDiversionClick = () => {
  if (vehicleTypeId === 22) {
    Swal.fire({
      title: 'Diversion Entry Confirmation',
      text: 'Are you sure you want to book this Diversion entry?',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        // ✅ Your stock diversion logic here
        console.log('Diversion Confirmed')

        // Example:
        // setActiveKey(5)
      } else {
        console.log('Diversion Cancelled')
      }
    })
  }
}
                    ...
                    <CTable caption="top" hover style={{ height: '55vh' }}>
                      ...
                      <CTableBody>
                        ...
                        <CTableRow>
                          ...
                          <CTableDataCell>Stock Diversion </CTableDataCell>
                          <CTableDataCell>
                            <CFormInput
