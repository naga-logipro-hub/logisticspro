...
const NlmtDocumentVerification = () => {
...
console.log('Vehicle Capacity List:', vehicleCapacity)
console.log('Capacity ID:', currentVehicleInfo?.nlmt_vehicle_info?.vehicle_capacity_id)
const getVehicleCapacityLabel = (capacityId) => {
  const cap = vehicleCapacity.find(
    (item) => Number(item.definition_list_id) === Number(capacityId)
  )
  return cap ? cap.definition_list_name : '-'
}

const getVehicleBodyLabel = (bodyId) => {
  const body = vehicleBody.find(
    (item) => Number(item.definition_list_id) === Number(bodyId)
  )
  return body ? body.definition_list_name : '-'
}
  ...
  useEffect(() => {
    ...
    NlmtShedMasterService.getShed().then((res) => {
  ...
  useEffect(() => {
    if (values.shedName != '0') {
      NlmtShedMasterService.getShedById(values.shedName).then((res) => {
  ...
  const ShedData = (id) => {
    NlmtShedMasterService.SingleShedData(id).then((resp) => {
  ...
  const addDocumentVerification = (status) => {
    ...
    formData.append('parking_id', currentVehicleInfo?.id)
    ...
    NlmtDocumentVerificationService.addDocumentVerificationData(formData)
      .then((res) => {
        setFetch(true)
        if (res.status == 200) {
                        ...
                        <CRow className="">
                          <CCol md={3}>
                            ...
                            <CFormInput
                              ...
                              size="sm"
                              id="vType"
                              value={currentVehicleInfo.nlmt_vehicle_info.vehicle_type_id}
                              readOnly
                            />
                          </CCol>
                          ...
                          <CCol md={3}>
                            ...
                            <CFormInput
                              ...
                              size="sm"
                              id="vNum"
                              value={`${currentVehicleInfo?.nlmt_vehicle_info?.vehicle_number}`}
                              readOnly
                            />
                          </CCol>
     <CCol md={3}>
                            ...
                            <CFormInput
                              ...
                              size="sm"
                              id="vNum"
                               value={`${getVehicleCapacityLabel(
    currentVehicleInfo?.nlmt_vehicle_info?.vehicle_capacity_id
  )} TON`}
                              readOnly
                            />
                          ...
                          <CCol xs={12} md={3}>
                            <CFormLabel htmlFor="dPhno">Driver Contact Number</CFormLabel>
                            <CFormInput
                              name="dPhno"
                              size="sm"
                              id="dPhno"
                            ...
                            />
                             ...
                             <CCol xs={12} md={3}>
                            <CFormLabel htmlFor="tripInDateTime">Trip-In Date & Time</CFormLabel>
                            <CFormInput
                              name="tripInDateTime"
                              size="sm"
                              id="tripInDateTime"
                              value={currentVehicleInfo?.trip_in_date_time}
                              readOnly
                            />
                          </CCol>
                          <CCol xs={12} md={3}>
...
export default NlmtDocumentVerification
