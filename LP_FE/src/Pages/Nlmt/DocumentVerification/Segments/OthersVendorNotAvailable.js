...
const OthersVendorNotAvailable = ({ onFocus, onBlur, handleChange, values, errors }) => {
  return (
    <>
      <CCol xs={12} md={3}>
      ...
      <CCol xs={12} md={3}>
        <CFormLabel htmlFor="bankAcc">
          Bank Account Number {'  '}
          {errors.bankAcc && <span className="small text-danger">{errors.bankAcc}</span>}
        </CFormLabel>
        <CFormInput
          name="bankAcc"
          size="sm"
...
export default OthersVendorNotAvailable
