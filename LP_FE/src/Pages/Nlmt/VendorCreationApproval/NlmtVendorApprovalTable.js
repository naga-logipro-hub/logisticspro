...
const NlmtVendorApprovalTable = () => {
  ...
  const loadVendorApprovalTable = () => {
    NlmtVendorCreationService.getVendorApprovalTableData().then((res) => {
    ...
    : data.vehicle_info?.vehicle_type_id,
          ...
          Action: (
            <CButton className="badge" color="warning">
              <Link className="text-white" to={`NlmtVendorCreationApproval/${data.vehicle_id}`}>
                Approve Vendor
              </Link>
            </CButton>
          ),
...
export default NlmtVendorApprovalTable
