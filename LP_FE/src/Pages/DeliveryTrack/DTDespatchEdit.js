...
const { id } = useParams()
  ...
  useEffect(() => {
    ...
    VehicleAssignmentService.getShipmentInfoBySId(id).then((res) => {  
      setFetch(true)
      ...
      if (res.status == 201) {
        Swal.fire({
          ...
          navigation('/DespatchHome')
        })
        return false
      }
      let dt_data = res.data.data 
      console.log(dt_data,'getDtInfoById')
      setShipmentNumberData(dt_data)
      setShipmentTrackInfo(dt_data.shipment_all_child_info)
      setShipmentHaving(true)
      mgioTimeUpdate(dt_data)
    })
  ...
  const mgioTimeUpdate = (data = '') => {
    setMgiTime(data ? data.mill_gate_in_time : '')
    setMgoTime(data ? data.mill_gate_out_time : '') 
  }
  ...
  const DTValidate = () => {
    ...
    formData.append('mgi_time', shipmentNumberData.mill_gate_in_time)
    formData.append('mgo_time', shipmentNumberData.mill_gate_out_time)
                ...
                <CTabContent>
                  <CTabPane className="row g-3 m-2 p-1" role="tabpanel" aria-labelledby="home-tab" visible={true}>
                    ...
                    <CRow className="mb-md-1">  
                      ...
                      <CCol md={3}>
                        <CFormLabel htmlFor="tripsheetNo"> Tripsheet No. / Plant </CFormLabel>
                        <CFormInput
                          name="tripsheetNo"
                          size="sm" 
                          id="tripsheetNo"
                          readOnly
                          value={`${shipmentNumberData && shipmentNumberData.trip_sheet_info ? shipmentNumberData.trip_sheet_info.trip_sheet_no : '-'} / ${shipmentNumberData && shipmentNumberData.shipment_vehicle_location_info ? shipmentNumberData.shipment_vehicle_location_info.location_code : '-'}`}                         
                        />
                      </CCol>                    
                      ...
                      <CCol md={3}>
                        ...
                        <CFormInput
                          ...
                          id="tripsheetNo"
                          readOnly
                          value={`${shipmentNumberData && shipmentNumberData.shipment_no} / ${shipmentNumberData && shipmentNumberData.created_at ? shipmentNumberData.created_at : '-'}`}                        
                        />
                      </CCol> 
                      ...
                      <CCol md={3}>
                        ...
                        <CFormInput
                          ...
                          readOnly
                          value={`${shipmentNumberData && shipmentNumberData.parking_yard_info ? shipmentNumberData.parking_yard_info.vehicle_number : '-'} / ${shipmentNumberData && shipmentNumberData.assigned_by ? (shipmentNumberData.assigned_by == '2' ? 'NLCD' : 'NLFD') : '-'}`}                        
                        />
                      </CCol>
                      ...
                      <CCol md={3}>
                        ...
                        <CFormInput
                          ...
                          id="shipmentQty"
                          readOnly
                          value={`${shipmentNumberData && shipmentNumberData.billed_net_qty ? shipmentNumberData.billed_net_qty + ' TON': ( shipmentNumberData.shipment_net_qty ? shipmentNumberData.shipment_net_qty + ' TON' : '-') } / ${shipmentNumberData.shipment_Vendor_info && shipmentNumberData.shipment_Vendor_info[0] && shipmentNumberData.shipment_Vendor_info[0].shed_name ? shipmentNumberData.shipment_Vendor_info[0].shed_name : '-'}`}                         
                        />
                      </CCol> 
                      ...
                      {/* <CCol md={3}>
                        ...
                        <CFormInput
                          ...
                          id="shipmentQty"
                          readOnly
                          value={`${shipmentNumberData && shipmentNumberData.billed_net_qty ? shipmentNumberData.billed_net_qty + ' TON': ( shipmentNumberData.shipment_net_qty ? shipmentNumberData.shipment_net_qty + ' TON' : '-') } / ${shipmentNumberData && shipmentNumberData.shipment_all_child_info ? shipmentNumberData.shipment_all_child_info.length : '-'}`}                         
                        />
                      </CCol> 
                        
                      {shipmentNumberData && shipmentNumberData.parking_yard_info && shipmentNumberData.parking_yard_info.vehicle_type_id_new == 3 && (
                        <CCol md={3}>
                          <CFormLabel htmlFor="shedName1"> Shed Name / Mobile No.</CFormLabel>
                          <CFormInput
                            name="shedName1"
                            size="sm" 
                            id="shedName1"
                            readOnly
                            value={`${shipmentNumberData.shipment_Vendor_info && shipmentNumberData.shipment_Vendor_info[0].shed_name ? shipmentNumberData.shipment_Vendor_info[0].shed_name : '-'} / ${shipmentNumberData.shipment_Vendor_info && shipmentNumberData.shipment_Vendor_info[0].owner_number ? shipmentNumberData.shipment_Vendor_info[0].owner_number : '-'} `}                         
                          />
                        </CCol>
                      )}                      */}
                      ...
                      <CCol md={3}>
                        ...
                        <CFormInput
                          ...
                          id="pygDriverName"
                          readOnly
                          value={`${shipmentNumberData && shipmentNumberData.parking_yard_info ? shipmentNumberData.parking_yard_info.driver_name : '-'} / ${shipmentNumberData && shipmentNumberData.parking_yard_info ? shipmentNumberData.parking_yard_info.driver_contact_number : '-'}`}                        
                        />
                      </CCol>
                      ...
                      <CCol md={3}>
                        ...
                        <CFormInput
                          ...
                          id="mgiTime"
                          readOnly
                          value={shipmentNumberData && shipmentNumberData.mill_gate_in_time ? formatDate(shipmentNumberData.mill_gate_in_time) : '-'}                         
                        />
                      </CCol>
                      ...
                      <CCol md={3}>
                        ...
                        <CFormInput
                          ...
                          id="mgoTime"
                          readOnly
                          value={shipmentNumberData && shipmentNumberData.mill_gate_out_time ? formatDate(shipmentNumberData.mill_gate_out_time) : '-'}                         
                        />
                      </CCol>
                      ...
                      <CCol md={3}>
                        ...
                        <CFormInput
                          ...
                          id="tptTime"
                          readOnly
                          value={shipmentNumberData && shipmentNumberData.truck_placement_time ? formatDate(shipmentNumberData.truck_placement_time) : '-'}                         
                        />
                      </CCol>
                      ...
                      <CCol md={3}>
                        ...
                        <CFormInput
                          ...
                          id="dotTime"
                          readOnly
                          value={shipmentNumberData && shipmentNumberData.despatch_do_time ? formatDate(shipmentNumberData.despatch_do_time) : '-'}                         
                        />
                      </CCol>
                    ...
                    {shipmentNumberData && shipmentNumberData.shipment_all_child_info && shipmentNumberData.shipment_all_child_info.map((val, val_index) => {
                      // console.log(val,'shipmentTrackInfo[val_index] - val')
                      // console.log(val_index,'shipmentTrackInfo[val_index] - val_index')
                      console.log(shipmentTrackInfo,'shipmentTrackInfo[val_index] - val_index')
                      return (
                        <>
                          ...
                          <CRow key={`HireshipmentChildData_${val_index}`}>
                            ...
                            <CCol md={2}>
                              ...
                              <CFormInput
                                ...
                                type="text"
                                // value={val.tl_name}
                                value={shipmentTrackInfo && shipmentTrackInfo[val_index] && shipmentTrackInfo[val_index]['tl_name']  ? shipmentTrackInfo[val_index]['tl_name'] : (`${val.tl_name ? val.tl_name: ''}`)}
                              />
                            </CCol>
