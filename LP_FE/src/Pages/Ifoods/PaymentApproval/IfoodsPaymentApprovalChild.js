...
const IfoodsPaymentApprovalChild = () => {
                              ...
                              <>
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="SRDateTime"
                                    value={expenseClosureData?.parking_yard_info?.ifoods_SalesRoute_info?.route_name?expenseClosureData?.parking_yard_info?.ifoods_SalesRoute_info?.route_name:''}
                                    readOnly
                                  />
                                </CCol>
                              </>
                                    ...
                                    {expenseClosureData.purpose == 1 && (
                                      <>
                                        ...
                                        <CCol xs={12} md={2}>
                                          ...
                                          <CCol xs={12} md={2}>
                                          <CFormLabel htmlFor="sInvoice">Delivery Date</CFormLabel>
                                      ...
                                      <CModal visible={visible} onClose={() => setVisible(false)}>
                                        ...
                                        <CModalBody>
                                          <img src={expenseClosureData.odometer_closing} alt="" />
                                        </CModalBody>
                                        <CModalBody>
                                          {expenseClosureData.odometer_closing &&
                                          !expenseClosureData.odometer_closing.includes('.pdf') ? (
...
export default IfoodsPaymentApprovalChild
