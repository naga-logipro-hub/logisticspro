...
const IfoodsExpenseApproval = () => {
  ...
  useEffect(() => {
    if (values.runningkm) {
      ///////////////////////// Purpose : Actual Vendor Freight Calculation /////////////////////////////////
   if(expenseClosureData.vendor_info.freight_type ==2)
   {
        let freight_info_data1 = values.runningkm
        let freight_info_data2 = expenseClosureData.parking_yard_info.ifoods_Salesfreight_info.freight_per_km
  ...
  }, [expenseClosureData,totalChargesDepo, values.runningkm])
 

  const expenseApproval = (type) => {
    /* Values Assigning To Save Details into DB Part Start*/

    var approve_km = values.runningkm
    let fregiht_1 = expenseClosureData.parking_yard_info.ifoods_Salesfreight_info.freight_per_km*values.runningkm
    let tot_fregiht_1 = Number (expenseClosureData.unloading_charges)+Number (expenseClosureData.weighment_charges)+Number (expenseClosureData.sub_delivery_charges)+Number (expenseClosureData.freight_adjustment)+Number (expenseClosureData.diversion_return_charges)+Number (fregiht_1)
    console.log(fregiht_1+"fregiht_1")
    console.log(tot_fregiht_1+"Tot_fregiht_1")
    const km_check =expenseClosureData.runningkm 
    const formData = new FormData()

    formData.append('approval_remarks', values.apremarks)
    formData.append('status', type == 1 ? 20 : 19)
    ...
    if(expenseClosureData.vendor_info.freight_type==1)
    {
      formData.append('freight_charges', expenseClosureData.freight_charges)
      formData.append('total_expenses', expenseClosureData.total_expenses)
      formData.append('updated_km', values.runningkm?values.runningkm:'0')
      formData.append('runningkm', values.runningkm?values.runningkm:expenseClosureData.runningkm)

    }
    if(expenseClosureData.vendor_info.freight_type==2)
    {
      formData.append('freight_charges', fregiht_1= fregiht_1? fregiht_1:expenseClosureData.freight_charges)
      formData.append('total_expenses', tot_fregiht_1=tot_fregiht_1? tot_fregiht_1:expenseClosureData.total_expenses)
      formData.append('updated_km', values.runningkm?values.runningkm:'0')
      formData.append('runningkm', values.runningkm?values.runningkm:expenseClosureData.runningkm)
    }
   
   
    if ( expenseClosureData.runningkm < values.runningkm  ) {
      setFetch(true)
      toast.warning('Approved KM Greater Than Running KM.')
      return false
    }
    

    IfoodsExpenseClosureService.updateExpenseApproval(formData)
      .then((res) => {
        setFetch(true)
        ...
        if (res.status == 200) {
          ...
          Swal.fire({
            ...
            title:
              type == 1
                ? 'Trip Additional Expenses Approved Successfully..!'
                : 'Trip Additional Expenses Rejected Successfully..!',
            confirmButtonText: 'OK',
          }).then(function () {
            navigation('/IfoodsExpenseApprovalHome')
          })
                  ...
                  <CTabPane role="tabpanel" aria-labelledby="home-tab" visible={mainKey === 1}>
                    ...
                    <CTabContent>
                      ...
                      >
                        ...
                        {expenseClosureData && (
                          <CRow className="">
                            {expenseClosureData.contractor_info && (
                              <>
                                <CCol md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="cname"
                                    value={expenseClosureData.contractor_info.contractor_name}
                                    readOnly
                                  />
                                </CCol>
                                ...
                                <CCol md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    value={locationFinder(
                                      expenseClosureData.contractor_info.contractor_location
                                    )}
                                    readOnly
                                  />
                                </CCol>
                                ...
                                <CCol md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="cmn"
                                    value={expenseClosureData.contractor_info.contractor_number}
                                    readOnly
                                  />
                                </CCol>
                                ...
                                <CCol md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    id="cfr"
                                    value={
                                      expenseClosureData.contractor_info.freight_type == '2'
                                        ? 'Actual Freight'
                                        : 'Budget Freight'
                                    }
                                    readOnly
                              ...
                              <>
                                ...
                                <CCol xs={12} md={3}>
                                  <CFormLabel htmlFor="vbt">
                                    Vehicle Capacity /Feet/ Body Type{' '}
                                  </CFormLabel>
                                  <CFormInput
                                    name="vbt"
                                    size="sm"
                                    id="vbt"
                                    value={`${expenseClosureData.vehicle_info.vehicle_capacity_info.capacity} - Ton /${expenseClosureData.vehicle_info.feet_info.capacity}- Feet / ${expenseClosureData.vehicle_info.vehicle_body_type_info.body_type}`}
                                    readOnly
                                  />
                                </CCol>
                                <CCol xs={12} md={3}>
                            ...
                            {expenseClosureData.driver_info && (
                              <>
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="dname"
                                    value={expenseClosureData.driver_info.driver_name}
                                    readOnly
                                  />
                                </CCol>
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="dmn"
                                    value={expenseClosureData.driver_info.driver_number}
                                    readOnly
                                  />
                                </CCol>
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="dln"
                                    value={expenseClosureData.driver_info.license_no}
                                    readOnly
                                  />
                                </CCol>
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="dlvt"
                                    value={expenseClosureData.driver_info.license_validity_to}
                                    readOnly
                                  />
                                </CCol>
                              </>
                            ...
                            {expenseClosureData.parking_yard_info && (
                              <CCol xs={12} md={3}>
                                ...
                                <CFormInput
                                  ...
                                  id="gateInDateTime"
                                  value={
                                    expenseClosureData.parking_yard_info.gate_in_date_time_string
                                  }
                                  readOnly
                                />
                              </CCol>
                            ...
                            {expenseClosureData.vehicle_inspection_info && (
                              <CCol xs={12} md={3}>
                              ...
                              <>
                                ...
                                <CCol md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    id="TDate"
                                    value={
                                      expenseClosureData.trip_sheet_info.ts_creation_time_string
                                    }
                                    readOnly
                                  />
                                </CCol>
                                <CCol md={3}>
                                  <CFormLabel htmlFor="TDate">Driver Name</CFormLabel>
                                  <CFormInput
                                    name="TDate"
                                    size="sm"
                                    id="TDate"
                                    value={expenseClosureData.parking_yard_info.driver_name}
                                    readOnly
                                  />
                                </CCol>
                                <CCol md={3}>
                                  <CFormLabel htmlFor="TDate">Driver Mobile Number</CFormLabel>
                                  <CFormInput
                                    name="TDate"
                                    size="sm"
                                    id="TDate"
                                ...
                                <CCol md={3}>
                                  <CFormLabel htmlFor="TDate">Purpose</CFormLabel>
                                  <CFormInput
                                    name="TDate"
                                    size="sm"
                                    id="TDate"
                                    value={expenseClosureData.purpose == 1 ? 'FG-Sales' : 'FG-STO'}
                                    readOnly
                                  />
                                </CCol>
                                  ...
                                  <>
                                    <CCol xs={12} md={3}>
                                      ...
                                      <CFormInput
                                        ...
                                        size="sm"
                                        id="SRDateTime"
                                        value={expenseClosureData.ifoods_SalesRoute_info.route_name}
                                        readOnly
                                      />
                                    </CCol>
                                  </>
                              ...
                              <>
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    id="SRDateTime"
                                    value={
                                      expenseClosureData.unplanned_km
                                        ? expenseClosureData.unplanned_km
                                        : expenseClosureData.ifoods_SalesRoute_info.budgeted_km
                                    }
                                    readOnly
                                  />
                                </CCol>
                              ...
                              <>
                                <CCol xs={12} md={3}>
                                  ...
                                  <CFormInput
                                    ...
                                    size="sm"
                                    id="SRDateTime"
                                    value={`${expenseClosureData.ifoods_StoRoute_info.from_location_info.location}  - ${expenseClosureData.ifoods_StoRoute_info.to_location_info.location} `}
                                    readOnly
                                  />
                                </CCol>
                              </>
                            ...
                            {/* {expenseClosureData.parking_yard_info.ifoods_SalesRoute_info>1 && (
                                      <>
                            <CCol xs={12} md={3}>
                              <CFormLabel htmlFor="trip_actual_km">Budgeted KM</CFormLabel>
                              <CFormInput
                                name="trip_actual_km"
                                size="sm"
                                id="trip_actual_km"
                            value={expenseClosureData.parking_yard_info.ifoods_SalesRoute_info.budgeted_km}
                                    readOnly
                              />
                            </CCol>
                            </>
                            ...
                            <CCol xs={12} md={3}>
                              ...
                              <CFormInput
                                ...
                                size="sm"
                                id="trip_actual_km"
                            value={expenseClosureData.runningkm-expenseClosureData.differencekm}
                                    readOnly
                              />
                            </CCol>
                            ...
                            <CCol xs={12} md={3}>
                              <CFormLabel htmlFor="trip_actual_km">Different KM</CFormLabel>
                              <CFormInput
                                name="trip_actual_km"
                                size="sm"
                                id="trip_actual_km"
                                value={expenseClosureData.differencekm}
                                    readOnly
                              />
                            </CCol>
                            <CCol xs={12} md={3}>
                              ...
                              <CFormInput
                                size="sm"
                                id="runningkm"
                                value={values.runningkm||expenseClosureData.runningkm}
                                onChange={handleChange}
                                name="runningkm"
                                onFocus={onFocus}
                                onBlur={onBlur}
                                className={`${errors.runningkm && 'is-invalid'}`}
                            ...
                            {expenseClosureData.parking_yard_info && (
                              <CCol xs={12} md={3}>
                                ...
                                <CFormInput
                                  ...
                                  id="gateOutDateTime"
                                  value={
                                    expenseClosureData.parking_yard_info.gate_out_date_time_string
                                  }
                                  readOnly
                                />
                              </CCol>
...
export default IfoodsExpenseApproval
