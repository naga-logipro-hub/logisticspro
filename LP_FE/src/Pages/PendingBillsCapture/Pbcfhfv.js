/* pbcfhfv : Pending Bills Capture Followup - Hire Foods (NLFD) Vehicles */ 
...
const pbcfhfv = () => { 
    ...
    let page_no = LogisticsProScreenNumberConstants.PendingBillsFollowupModule.PBFC_Hire_Vehicles_NLFD_Report
  ...
  /* ==================== Access Part End ========================*/
    ...
    const exportToCSV = (e1) => {
        ...
        let fileName='Hire_Vehicles_NLFD_BPC_Report_'+dateTimeString
    ...
    const loadTripShipmentReport = (fresh_type = '') => {
        ...
        if (fresh_type !== '1') {   
            TripInfoCaptureService.PBFCHireVehiclesNLFDReport().then((res) => {  
