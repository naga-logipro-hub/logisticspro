...
const SINGLE_DIESEL_LIST = AppConfig.api.baseUrl+ '/nlmt_diesel_intent_register'  // NLMT
...
const SINGLE_TRIP_SHEET_LIST = AppConfig.api.baseUrl+ '/nlmt_singlereport'
const TRIPSHEET_VEHICLE_REPORT_URL = AppConfig.api.baseUrl+ '/nlmt_vehicle_data_capture_tripsheet'
const INSPECTION_REPORT_URL = AppConfig.api.baseUrl+ '/Inspection_report'
const INSPECTION_VEHICLE_REPORT_URL = AppConfig.api.baseUrl+ '/nlmt_vehicle_data_capture_inspection'
const INSPECTION_PREVIOUS_REPORT_URL = AppConfig.api.baseUrl+ '/previous_load_details_data'
const MAINTENANCE_BY_REPORT_URL = AppConfig.api.baseUrl+ '/nlmt_maintenance_by_data'
const MAINTENANCE_VEHICLE_REPORT_URL = AppConfig.api.baseUrl+ '/nlmt_maintenance_vehicle_data'
const RJ_SALES_ORDER_REPORT = AppConfig.api.baseUrl+ '/nlmt_RJ_SO_report'
const RJ_SALES_VEHICLE_REPORT_URL = AppConfig.api.baseUrl+ '/nlmt_vehicle_data_rj_so_creation'
const RJ_CUSTOMER_REPORT = AppConfig.api.baseUrl+ '/nlmt_RJ_customer_report'
const RJ_CREATION_TYPE_URL = AppConfig.api.baseUrl+ '/nlmt_customer_creation_type'
const RJ_CUSTOMER_STATUS_URL = AppConfig.api.baseUrl+ '/nlmt_customer_creation_status'
const DOCUMENT_VERIFY_REPORT = AppConfig.api.baseUrl+ '/nlmt_Document_verifigation_report'
const DOCUMENT_VERIFY_REPORT_WITH_IMAGE = AppConfig.api.baseUrl+ '/nlmt_Document_Report'
const VEHICLE_DOCUMENT_DATA = AppConfig.api.baseUrl+ '/nlmt_vehicle_data_get_document'
const VENDOR_CREATION_REPORT = AppConfig.api.baseUrl+ '/nlmt_vendor_report'
const VENDOR_CREATION_STATUS = AppConfig.api.baseUrl+ '/nlmt_vehicle_data_get_document'
const RJ_SO_OS_RECEIVABLE_VECHILE_URL = AppConfig.api.baseUrl+ '/nlmt_rj_so_os_rec_vehicleno'
const RJ_SO_OS_RECEIVABLE_SHED_NAME_URL = AppConfig.api.baseUrl+ '/nlmt_rj_so_os_rec_shed_name'
...
export default new  NlmtReportService()
